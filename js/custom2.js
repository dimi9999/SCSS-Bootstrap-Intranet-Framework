...
$(document).ready(function () {
    ...
    setTimeout(function () {
        ...
        // MEGAMENU MOBILE
        $('.navarea > ul > li').click(function (event) {
            ...
            function (e) { //ONMOUSEOVER
                ...
                if (breakpointH2) {
                    ...
                    menuTimeout = setTimeout(function () {
                        ...
                        menuItem.next('.navdropcontainer').slideDown('slow');
               ...
               if (breakpointH2) {
                   if (typeof menuTimeout != 'undefined') {
                    ...
                    var menuItem = $(this);
                     ...
                     menuItem.next('.navdropcontainer').slideUp('slow');
        ...
        $(".navdropcontainer").mouseenter(function () {
            $(this).css('display','block');
        });
        $(".navdropcontainer").mouseleave(function () {
            $(this).slideUp('slow');
        });
